...
if (headerInner) {
  ...
  fetch("./includes/components/header.html")
    ...
    .then((data) => {
      ...
      if (lastSegment == "" || lastSegment == "index" || lastSegment == "index2") {
...
// [ So that we don't have a problem when it is not exist ]
if (sliderInner) {
  fetch("./includes/components/sliderOurCheffs.html")
    .then((result) => result.text())
    .then((data) => {
...
// [ So that we don't have a problem when it is not exist ]
if (sectionCounter) {
  fetch("./includes/components/counter.html")
    .then((result) => result.text())
    .then((data) => {
...
// [ So that we don't have a problem when it is not exist ]
if (sliderTeamCheff) {
  fetch("./includes/components/sliderteamCheff.html")
    .then((result) => result.text())
    .then((data) => {
...
if (sliderSatisfaction) {
  fetch("./includes/components/slidersatisfaction.html")
    .then((result) => result.text())
    .then((data) => {
...
// [ So that we don't have a problem when it is not exist ]
if (masterChef) {
  fetch("./includes/components/sliderMasterCheff.html")
    .then((result) => result.text())
    .then((data) => {
...
if (tab_Inner) {
  ...
  fetch("./includes/components/description.html")
    .then((result) => result.text())
  ...
  tabs.forEach((tab) => {
    tab.addEventListener("click", () => {
      ...
      if (tab.dataset.tab == "description") {
        ...
        fetch("./includes/components/reviews.html")
          .then((result) => result.text())
          .then((data) => {
